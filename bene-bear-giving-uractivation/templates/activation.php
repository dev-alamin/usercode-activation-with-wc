<div class="bbg-activation-wrapper">
    ...
    if (isset($_POST['submit_urcode'])) {
        ...
        if (!empty($key)) {
            ...
            if (0 == $update_code_list_status) {
                ...
                echo '<script>alert("You have activated a new Bear, awesome");</script>';
            }
        }
    }
    ?>
    ...
    <p>You have <?php echo (get_activated_item_list() ? count(get_activated_item_list()) : '0'); ?> activated bear right now</p>
